...
datasets = ["aids", "bbbp", "ba2motifs", "mutag", "proteins"]
#datasets = ["aids" ]
#datasets = ["bbbp", "aids", "ba2motifs", "mutag"]
#datasets = ["bbbp", "aids", "ba2motifs"]
#datasets = ["ba2motifs", "bbbp", "aids"]
datasets = ["mutag"]
savepoint = {
    "rerun_extraction": False,
    "rerun_pattern_mining" : False,
    "rerun_perturbation_serch": True
}
...
experiments = [
    ...
    #{"xpl": "actexplainer", "topK": False, "K": 0, "policy_name": "node", "name": "Inside GNN node", "k": 10, "motifs": "base", "negation": False},
    ...
    #{'xpl': 'actexplainer', 'topK': False, 'K': 0, 'policy_name': 'ego', 'name': 'Inside GNN ego', 'k': 10, 'motifs': 'base', 'rerun_extraction': True, 'rerun_pattern_mining': False, 'rerun_perturbation_serch': True, 'groundtruth': False}
     ]
