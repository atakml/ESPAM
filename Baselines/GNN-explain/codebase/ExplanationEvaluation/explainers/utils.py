...
class RuleEvaluator:
    ...
    def load_rules(dataset):
        ...
        file = "ExplanationEvaluation/datasets/activations/" + name + "/" + name + "_activation_encode_motifs_ex.csv"
        file = "ExplanationEvaluation/datasets/activations/" + name + "/" + name + "_activation_encode_motifs_beam.csv"
        file = "ExplanationEvaluation/datasets/activations/" + name + "/" + name + "_activation_single.csv"
