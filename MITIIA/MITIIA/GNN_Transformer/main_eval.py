...
from GNN_Transformer.metrics import log_confusion_matrix, log_roc_curve, precision_recall_fscore, MCC, roc_auc, roc_curve, precision_recall_curve, average_precision_score, true_negative_rate, log_pr_curve
...
from GNN_Transformer.make_create_optimizer import make_create_optimizer # For loading purposes
from GNN_Transformer.make_eval import make_valid_epoch
...
def main_eval(hparams):
    ...
    if hparams['LOADER_OUTPUT_TYPE'] == 'jax':
        ...
        valid_loader = _valid_loader.tf_Dataset(output_signature = get_tf_specs(is_weighted = False, 
                                                                                n_partitions = hparams['N_PARTITIONS'],
