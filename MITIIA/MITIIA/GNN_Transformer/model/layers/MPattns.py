...
from GNN_Transformer.model.layers.attention import MultiHeadDotProductAttention_with_AttnWeights_and_QKV
...
class GTransformerEncoderLayer(flax.linen.Module):
    """
    """
    _mpnn_Q : Callable
    _mpnn_K : Callable
